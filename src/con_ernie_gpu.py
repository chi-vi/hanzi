...
vocab_file = "./config/con/vocabs-ernie.json"
config_file = "./config/con/config-ernie.json"
tokenizer_path = "./tokenizer/ernie"
model_path = "./model/con-ctb9-ernie-gram.pt"
...
model.load_state_dict(torch.load(model_path, map_location='cuda', weights_only=True), strict=False)  # device etc...
model.eval()
